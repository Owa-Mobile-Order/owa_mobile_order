...
import { Box, Button, Card, FormControl, FormErrorMessage, FormHelperText, FormLabel, Heading, Input, Text, Textarea } from "@chakra-ui/react";
...
const Page: NextPage = () => {
  ...
  const handleTitleInput = (e: ChangeEvent<HTMLInputElement>) => setTitle(e.target.value)
  ...
  if (status !== "authenticated") {
    return (
      ...
      <Box textAlign={"center"} m="40px">
        ...
        <Text>アプリの感想・バグ報告・「こんな機能を追加してほしい」などをお聞かせください</Text>
        ...
        <Button onClick={handleSubmit} isLoading={isSubmit} m="0 auto">回答を送信</Button>
        </Card>
      </Box>
      </>
    )
